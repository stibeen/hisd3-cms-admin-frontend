        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-50">
            ...
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md border border-gray-100">
                ...
                >
                    ...
                    >
                        <Input prefix={<UserOutlined className="site-form-item-icon text-gray-400" />} placeholder="Username" size="large" />
                    </Form.Item>
                    <Form.Item
                        name="password"
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit" className="w-full bg-[#1280ED]" size="large" loading={loading} disabled={loading}>
                            Log in
                        </Button>
                    </Form.Item>
                </Form>
