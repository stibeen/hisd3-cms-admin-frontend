        ...
        <Space>
          ...
          {inquiry?.status !== "ARCHIVED" && (
            <Button
              ...
              onClick={() => handleArchiveButton(inquiry?.id || "")}
            >
              Archive
            </Button>
          )}
          ...
          >
            <Descriptions column={1} layout="vertical">
              <Descriptions.Item
                label={
                  <Space>
                    <MailOutlined className="text-[#1280ED]" />{" "}
              ...
              <Descriptions.Item
                label={
                  <Space>
                    <PhoneOutlined className="text-[#1280ED]" />{" "}
              ...
              <Descriptions.Item
                label={
                  <Space>
                    <CalendarOutlined className="text-[#1280ED]" />{" "}
