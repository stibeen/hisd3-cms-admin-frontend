...
export type AdminProductQuery = { __typename?: 'Query', categoriesAdmin: Array<{ __typename?: 'Category', id: string, name: string }>, adminProduct?: { __typename?: 'AdminProductEntity', id: string, icon?: string | null, name: string, tagline?: string | null, description?: string | null, isActive: boolean, createdAt: any, updatedAt: any, slug: string, order: number, category?: { __typename?: 'Category', id: string, name: string } | null, media?: Array<{ __typename?: 'Media', id: string, url: string }> | null } | null };
